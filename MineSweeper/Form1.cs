...
namespace MineSweeper
{
    public partial class Form1 : Form
    {
        ...
        private void CountRemainingBombs()
        {
            ...
            label_BombsRemaining.Text = ((Grid1.bombcount - x).ToString());
        }
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Do you wish to continue playing?", "Keep Playing?", MessageBoxButtons.YesNo);
